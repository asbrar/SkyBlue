...
struct ProfileView: View {
    ...
    func deleteAccount(){
        ...
        Task{
            do{
                ...
                //Delete user posts
                await deletePosts(userUID: userUID)
    ...
    //Deleteing posts with user uid
    func deletePosts(userUID: String) async {
    do{
        let query = Firestore.firestore().collection("Posts").whereField("userUID", isEqualTo: userUID)
